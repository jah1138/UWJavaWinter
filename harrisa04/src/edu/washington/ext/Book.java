...
public class Book {
    ...
    /**
     * This field will contain a version of the book description which has been
     * formatted for the word counting methods.
     */
    ...
    Book(String author, String title, String description, String publisher, Binding binding) {
        ...
        refNumber = "";
        /**
         * This is a version of the book description which has been formatted
         * for the word counting methods. All punctuation is removed and the
         * text set to lower case. The original book description is unchanged.
         */
