...
public class DiscountException extends Exception {
    ...
    /**
     * Constructs a new edu.washington.ext.DiscountException with an non-specific message.
     */
    ...
    /**
     * Constructs a new edu.washington.ext.DiscountException with the specified detail message.
